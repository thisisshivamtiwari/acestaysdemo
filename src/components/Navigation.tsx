                  ...
                  <div className="absolute top-full left-0 mt-3 w-[500px] bg-white rounded-2xl shadow-2xl border border-gray-100 py-8 overflow-hidden">
                    <div className="grid grid-cols-2 gap-4 px-8">
                      ...
                      <div className="space-y-3">
                        {leftColumnCities.map((city, index) => (
                          <div key={index} className="group flex items-center space-x-4 p-4 hover:bg-gradient-to-r hover:from-cream hover:to-blush-pink rounded-xl cursor-pointer transition-all duration-300 hover:shadow-md hover:scale-[1.02]">
                            ...
                            <div className="flex-1">
                              <span className="text-base font-semibold text-gray-900 group-hover:text-terracotta transition-colors duration-200">{city.name}</span>
                              <div className="text-xs text-gray-500 mt-1">Premium stays available</div>
                            </div>
                            <svg className="w-5 h-5 text-gray-400 group-hover:text-terracotta group-hover:translate-x-1 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100 px-8">
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-terracotta hover:text-terracotta/80 text-sm font-medium flex items-center space-x-1 transition-colors duration-200">
                          <span>View All</span>
