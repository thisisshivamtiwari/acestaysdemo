    ...
    <div>
      ...
      <div className="grid grid-cols-7 gap-2">
        {cells.map((cell, idx) => {
          ...
          const base = d ? (isDisabled ? 'bg-gray-50 text-gray-300 border border-gray-100 cursor-not-allowed' : 'bg-white text-gray-700 border border-gray-200 hover:border-terracotta/30 hover:bg-cream') : 'opacity-0 pointer-events-none'
          return (
            <button
              key={idx}
            ...
            >
              ...
              {range && <span className="absolute inset-0 rounded-md" style={{ backgroundColor: 'rgba(245, 240, 230, 0.5)' }} />}
            </button>
          )
        })}
      </div>
          ...
          >
            ...
            <div className="px-6 pt-4 pb-3 border-b border-gray-200">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  ...
                  {nights > 0 && <span className="ml-2 px-2 py-0.5 rounded-full" style={{ backgroundColor: '#F5F0E6', color: '#A0523D' }}>{nights} nights</span>}
                </div>
            ...
            <div className="flex-1 overflow-auto p-6">
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                {/* Banner with image */}
                <div className="mt-8 rounded-2xl p-6 text-white flex items-center gap-6" style={{ background: 'linear-gradient(135deg, #A0523D 0%, #8B4535 100%)' }}>
            ...
            <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between gap-3">
              <div className="text-sm text-gray-600">
                ...
                {nights > 0 && <span className="ml-2" style={{ color: '#A0523D' }}>• {nights} nights</span>}
              </div>
