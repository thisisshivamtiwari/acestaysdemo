...
export const brandBlue = '#A0523D' // Changed to terracotta to match footer theme
...
export function Tag({ children }: { children: React.ReactNode }) {
  return (
    <span className="text-xs px-2 py-1 rounded-md" style={{ backgroundColor: '#F5F0E6', color: '#A0523D' }}>{children}</span>
  )
}
