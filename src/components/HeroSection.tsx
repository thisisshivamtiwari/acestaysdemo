          ...
          <div className="text-white space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                ...
                <span className="block" style={{color: '#A0523D'}}>hello acestayz</span>
              </h1>
              ...
              <form onSubmit={handleSearchSubmit} className="relative">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 text-lg bg-white/95 backdrop-blur-sm border-0 rounded-2xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-4 focus:bg-white transition-all duration-300 shadow-2xl" style={{'--tw-ring-color': '#A0523D'} as React.CSSProperties}
                  />
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white px-6 py-2 rounded-xl font-semibold transition-colors duration-200" style={{backgroundColor: '#A0523D'}} onMouseEnter={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#8B4535'} onMouseLeave={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#A0523D'}
                  >
                    Search
                  </button>
                </div>
            ...
            {/* Call to Action */}
            <div className="flex items-center space-x-2" style={{color: '#A0523D'}}>
            ...
            <div className="flex flex-wrap gap-8 pt-4">
              <div className="text-center">
                <div className="text-3xl font-bold" style={{color: '#A0523D'}}>6+</div>
                <div className="text-sm text-gray-300">Years Experience</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold" style={{color: '#A0523D'}}>500+</div>
                <div className="text-sm text-gray-300">Happy Guests</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold" style={{color: '#A0523D'}}>15+</div>
            ...
            <div className="relative">
              ...
              <div className="absolute top-0 right-0 w-80 h-96 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 p-6 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-bold text-xl" style={{color: '#A0523D'}}>₹4,999/night</span>
                  <button className="text-white px-4 py-2 rounded-lg font-semibold transition-colors" style={{backgroundColor: '#A0523D'}} onMouseEnter={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#8B4535'} onMouseLeave={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#A0523D'}>
                    Book Now
                  </button>
                </div>
              </div>
              ...
              <div className="absolute top-20 left-0 w-72 h-80 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 p-6 transform -rotate-2 hover:rotate-0 transition-transform duration-300">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-bold text-xl" style={{color: '#A0523D'}}>₹2,999/night</span>
                  <button className="text-white px-4 py-2 rounded-lg font-semibold transition-colors" style={{backgroundColor: '#A0523D'}} onMouseEnter={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#8B4535'} onMouseLeave={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#A0523D'}>
                    Book Now
                  </button>
                </div>
