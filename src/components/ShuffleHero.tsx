...
const ShuffleHero: React.FC = () => {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
      <div>
        <span className="block mb-4 text-xs md:text-sm font-medium" style={{ color: '#A0523D' }}>Discover more</span>
        ...
        <button
          ...
          style={{ backgroundColor: '#A0523D' }}
          onMouseEnter={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#8B4535'}
          onMouseLeave={(e) => (e.target as HTMLButtonElement).style.backgroundColor = '#A0523D'}
