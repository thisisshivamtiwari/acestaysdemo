    ...
    <section className="w-full px-4 sm:px-6 lg:px-8 py-16 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-semibold mb-6" style={{ color: '#A0523D' }}>
        ...
        >
          ...
          <button
            ...
            style={{ backgroundColor: canGoPrevious ? 'rgba(160, 82, 61, 0.9)' : 'rgba(229, 231, 235, 0.8)' }}
                ...
                <div key={slideIndex} className="min-w-full">
                  ...
                  <div className="grid grid-cols-4 gap-8 mb-8">
                    {hotels.slice(slideIndex * 8, slideIndex * 8 + 4).map((hotel) => (
                      <div onClick={goDetail} role="link" tabIndex={0} key={hotel.id} className="bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300 group border border-gray-100 cursor-pointer focus:outline-none focus:ring-2" style={{'--tw-ring-color': '#A0523D'} as React.CSSProperties}>
