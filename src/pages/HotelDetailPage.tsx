...
const HotelDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Terracotta Summary Bar */}
      <section className="relative z-10 -mt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl shadow-xl p-6 md:p-8 bg-terracotta-texture">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              ...
              <div className="w-full md:w-auto">
                <div onClick={() => setCalendarOpen(true)} className="bg-white rounded-xl px-4 py-3 text-sm text-gray-700 border w-full md:w-[420px] cursor-pointer hover:shadow flex items-center justify-between" style={{ borderColor: '#A0523D' }}>
      ...
      <div className="h-[65vh] w-full relative">
        ...
        <div className="absolute inset-x-0 bottom-4 flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <button onClick={onOpenGallery} className="rounded-full p-3 shadow-md text-white" style={{ backgroundColor: '#A0523D' }}>
              <FiCamera />
            </button>
          </div>
        </div>
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="relative">
        ...
        <button
          ...
          style={{ backgroundColor: canPrev ? 'rgba(160, 82, 61, 0.9)' : 'rgba(229,231,235,0.8)' }}
        >
          <FiChevronLeft />
        </button>
